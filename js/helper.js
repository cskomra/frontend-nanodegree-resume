...
var HTMLworkHeading = '<h2>Work Experience</h2>';
...
var HTMLprojectHeading = '<h2><a href="#projects">Projects</a></h2>';
...
var HTMLschoolHeading = '<h2>Education</h2>';
var HTMLschoolStart = '<div class="education-entry"></div>';
var HTMLschoolName = '<a href="#" target="_blank">%data%';
var HTMLschoolDegree = ' -- %data%</a>';
var HTMLschoolNoDegree = '</a>';
var HTMLschoolDates = '<div class="date-text">%data%</div>';
var HTMLschoolLocation = '<div class="location-text">%data%</div>';
var HTMLschoolMajor = '<br><div class="pos-text"><em>Program of Study: %data%</em></div>';

var HTMLonlineClasses = '<h3>Online Classes</h3>';
var HTMLonlineTitle = '<a href="#">%data%';
var HTMLonlineSchool = ' - %data%</a>';
var HTMLonlineDates = '<div class="oc-date-text">%data%</div>';
var HTMLonlineURL = '<br><a href="#">%data%</a>';

var internationalizeButton = '<button>Internationalize</button>';
var googleMap = '<div id="map"></div>';
var HTMLmapHeading = "<h2>Where I've Lived and Worked</h2>";
